...
namespace CapaPresentacion
{
    public partial class Localidades : System.Web.UI.Page
    {
        ...
        {
            return NLocalidad.GetInstance().ListaLocalidades();
        }

        [WebMethod]
        public static Respuesta<bool> Guardar(ELocalidad oLocalidad)
        {
            return NLocalidad.GetInstance().RegistrarLocalidad(oLocalidad);
        }

        [WebMethod]
        public static Respuesta<bool> Editar(ELocalidad oLocalidad)
        {
            return NLocalidad.GetInstance().EditarLocalidad(oLocalidad);
        }
    }
}